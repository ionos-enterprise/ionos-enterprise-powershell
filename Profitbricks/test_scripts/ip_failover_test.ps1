...
$newServer = New-PBServer -DataCenterId $newDc.Id -Name "PowerShell SDK Test" -DiskType $image.Properties.ImageType -ImageId $image.Id -SshKey keysshtest -Cores 1 -Ram 1073741824 -PublicIp 0 -StaticIp 1

$newLan = New-PBLan -DataCenterId $newDc.Id -Name "PowerShell SDK Test" -Public $true
...
$updatedLan = Set-PBLan -DataCenterId $newDc.Id -LanId $newLan.Id -Name "PowerShell SDK Test RENAME" -Public $true -IpFailover $ipFailovers

start-sleep -seconds 20

$newServer2 = New-PBServer -DataCenterId $newDc.Id -Name "PowerShell SDK Test 2" -DiskType $image.Properties.ImageType -ImageId $image.Id -SshKey keysshtest -Cores 1 -Ram 1073741824 -PublicIp 0 -StaticIp 1
